...
// Full implementation in Story 1.8 (admin auth).
 ...
 *
 * Story 1.8 wires the auth interceptor.
 */
...
// TODO: Story 1.8 — add auth interceptor (request + response)
// TODO: Story 1.8 — add 401 → token refresh → retry logic
